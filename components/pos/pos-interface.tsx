...
import { UserAccount } from "@/components/pos/user-account";
...
const products: Product[] = [
  {
    ...
    category: "Food",
    description:
      "Fresh organic greens with a variety of toppings and house-made dressing.",
  ...
  },
  {
    ...
    category: "Desserts",
    description:
      "Delicious cookies made with gluten-free flour and organic chocolate chips.",
  ...
  },
  {
    ...
    category: "Food",
    description:
      "Whole grain toast topped with fresh avocado, microgreens, and spices.",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=120&width=120&text=Tote+Bag",
  },
  {
    id: "p8",
    ...
    price: 4.5,
    category: "Desserts",
    description: "Rich, fudgy brownie made with fair-trade chocolate.",
    image: "/placeholder.svg?height=120&width=120&text=Brownie",
  },
];
...
export function POSInterface({ name, image }: ProfileDropdownProps) {
        ...
        <header className="bg-white p-4 border-b">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold">Organic Delights</h1>
            ...
            <div className="relative">
              <UserAccount name={name} image={image}/>
            </div>
          </div>
        ...
        <Card className="flex flex-col h-full border-0 rounded-none">
          ...
          <CardFooter className="flex-col border-t pt-4">
            <div className="w-full space-y-2">
              ...
              <Button
                className="w-full mt-4 bg-pos-primary hover:bg-pos-secondary text-white"
                size="lg"
