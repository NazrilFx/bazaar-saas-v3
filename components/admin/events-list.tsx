...
import { CalendarDays, Edit, MapPin, MoreHorizontal, Store, Users } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function AdminEventsList({ status }: AdminEventsListProps) {
          ...
          <TableRow key={event.id}>
            ...
            <TableCell>
              <div className="flex items-center gap-1">
                ...
                <span>{event.vendorCount}</span>
              </div>
            </TableCell>
            <TableCell>
              <div className="flex items-center gap-1">
                <Users className="h-3.5 w-3.5 text-muted-foreground" />
                <span>{event.storeCount}</span>
              </div>
            </TableCell>
            <TableCell>
              <Badge
