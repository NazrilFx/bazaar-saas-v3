...
interface StorePOSPaymentModalProps {
  isOpen: boolean
  onClose: () => void
  total: number
...
export function StorePOSPaymentModal({ isOpen, onClose, total, onPaymentComplete }: StorePOSPaymentModalProps) {
            ...
            <Tabs defaultValue="qris" className="w-full">
              ...
              <TabsContent value="qris" className="mt-4">
                <div className="flex flex-col items-center justify-center">
                  <div className="bg-white p-4 rounded-lg border mb-4">
                    <div className="relative w-[200px] h-[200px]">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <QrCode className="h-16 w-16 text-store-primary opacity-50" />
                      </div>
                    </div>
                  </div>
                  ...
                  <Button
                    className="w-full bg-store-primary hover:bg-store-secondary text-white"
